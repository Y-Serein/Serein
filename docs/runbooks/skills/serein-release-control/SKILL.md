...
- Do not modify `examples/serein-prototype/` unless explicitly requested.
...
apps/serein-desktop/src/domain/model.ts
...
Put longer lessons, preferences, prompt templates, and pitfalls in `docs/runbooks/PROJECT_MEMORY.md`.
